  ...
  class WorkflowEngine
    ...
    def initialize(options)
      ...
      begin
        ...
        # overwrite all server options to false for the --no-server situation
    ...
    def run
      with_locked_db {
        ...
        # Get new cycles that need to be activated now, unless we are only updating status
        get_new_cycles unless @options.harvest_only
